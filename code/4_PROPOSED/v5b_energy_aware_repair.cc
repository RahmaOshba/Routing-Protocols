...
// RESULT of this exact file (seed 12345): FND 1645 / HND 1996 / LND 2116 / PDR 98.62%
...
int main(int argc, char* argv[])
{
    ...
    cout << "\n========================================\n";
    cout << "  HYBRID v5b: v5(Backup Failover + Chain/Cluster Repair) + IMPROVEMENT 2 (Energy-Aware Repair)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("v5b_energy_aware_repair-clustering.xml");
    ...
    ofstream rounds("v5b_energy_aware_repair-results.csv");
    ofstream energy("v5b_energy_aware_repair-node-energy.csv");
    ofstream lifetime("v5b_energy_aware_repair-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v5b_energy_aware_repair-results.csv, v5b_energy_aware_repair-node-energy.csv,\n";
    cout << "             v5b_energy_aware_repair-node-lifetime.csv, v5b_energy_aware_repair-clustering.xml\n";
    cout << "========================================\n";
