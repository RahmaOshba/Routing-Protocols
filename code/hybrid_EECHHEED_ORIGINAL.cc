...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-EECHHEED-ORIGINAL-clustering.xml");
    ...
    ofstream rounds("hybrid-EECHHEED-ORIGINAL-results.csv");
    ofstream energy("hybrid-EECHHEED-ORIGINAL-node-energy.csv");
    ofstream lifetime("hybrid-EECHHEED-ORIGINAL-node-lifetime.csv");
