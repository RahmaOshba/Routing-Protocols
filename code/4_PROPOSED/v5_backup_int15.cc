...
// RESULT of this exact file (seed 12345): FND 1438 / HND 2131 / LND 2401 / PDR 98.44%
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("v5_backup_int15-clustering.xml");
    ...
    ofstream rounds("v5_backup_int15-results.csv");
    ofstream energy("v5_backup_int15-node-energy.csv");
    ofstream lifetime("v5_backup_int15-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v5_backup_int15-results.csv, v5_backup_int15-node-energy.csv,\n";
    cout << "             v5_backup_int15-node-lifetime.csv, v5_backup_int15-clustering.xml\n";
    cout << "========================================\n";
