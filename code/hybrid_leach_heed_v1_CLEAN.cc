...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v1-clustering.xml");
    ...
    ofstream rounds("hybrid-v1-results.csv");
    ofstream energy("hybrid-v1-node-energy.csv");
    ofstream lifetime("hybrid-v1-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v1-results.csv, hybrid-v1-node-energy.csv,\n";
    cout << "             hybrid-v1-node-lifetime.csv, hybrid-v1-clustering.xml\n";
    cout << "========================================\n";
