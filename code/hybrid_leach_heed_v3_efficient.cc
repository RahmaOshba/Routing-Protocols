...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v3-clustering.xml");
    ...
    ofstream rounds("hybrid-v3-results.csv");
    ofstream energy("hybrid-v3-node-energy.csv");
    ofstream lifetime("hybrid-v3-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v3-results.csv, hybrid-v3-node-energy.csv,\n";
    cout << "             hybrid-v3-node-lifetime.csv, hybrid-v3-clustering.xml\n";
    cout << "========================================\n";
