// ============================================================================
// SH-LEACH (2015) -- EDITED (unified environment for fair cross-protocol comparison)
// ns-3.41 / C++
//
// SAME ALGORITHM as hybrid_SHLEACH_ORIGINAL.cc (paper Eq. 3 CH probability
// inside LEACH's round structure) -- only the ENVIRONMENT is standardized to
// match LEACH/HEED/PEGASIS/EECH-HEED: two-slope Efs/Emp/d0 radio model,
// packet = 2000 bits, BS at the field centre, N = 100, 100x100 m field.
// For the paper-faithful reproduction, see hybrid_SHLEACH_ORIGINAL.cc.
// ============================================================================
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("shleach_EDITED-clustering.xml");
    ...
    ofstream rounds("shleach_EDITED-results.csv");
    ofstream energy("shleach_EDITED-node-energy.csv");
    ofstream lifetime("shleach_EDITED-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: shleach_EDITED-results.csv, shleach_EDITED-node-energy.csv,\n";
    cout << "             shleach_EDITED-node-lifetime.csv, shleach_EDITED-clustering.xml\n";
    cout << "========================================\n";
