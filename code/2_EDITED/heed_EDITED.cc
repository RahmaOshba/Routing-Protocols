...
int main(int argc, char* argv[])
{
    ...
    cout << "Visualization = heed_EDITED-clustering.xml (NetAnim)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("heed_EDITED-clustering.xml");
    ...
    ofstream rounds("heed_EDITED-results.csv");
    ofstream energy("heed_EDITED-node-energy.csv");
    ofstream lifetime("heed_EDITED-node-lifetime.csv");
    ...
    cout << "\nCSV outputs:\n";
    cout << "  heed_EDITED-results.csv\n";
    cout << "  heed_EDITED-node-energy.csv\n";
    cout << "  heed_EDITED-node-lifetime.csv\n";
    cout << "  heed_EDITED-clustering.xml\n";
    cout << "========================================\n";
