...
// ns-3.41 / C++
//
// VARIANT requested to isolate two things at once against hybrid_leach_heed_
// v7_center.cc: (1) what backup-only (no chain) looks like -- direct CH->BS
...
// as v7_center.cc -- ONLY the chain mechanism (removed) and SETUP_INTERVAL
// (5->10) differ, so comparing against v7_center isolates the chain's own
// contribution, and comparing against v5_backup.cc (interval=15) isolates
// the interval choice.
//
...
// hybrid_leach_heed_v7_center.cc for the chain mechanism this variant
// deliberately omits.
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v7-center-noChain-int10-clustering.xml");
    ...
    ofstream rounds("hybrid-v7-center-noChain-int10-results.csv");
    ofstream energy("hybrid-v7-center-noChain-int10-node-energy.csv");
    ofstream lifetime("hybrid-v7-center-noChain-int10-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v7-center-noChain-int10-results.csv, hybrid-v7-center-noChain-int10-node-energy.csv,\n";
    cout << "             hybrid-v7-center-noChain-int10-node-lifetime.csv, hybrid-v7-center-noChain-int10-clustering.xml\n";
    cout << "========================================\n";
