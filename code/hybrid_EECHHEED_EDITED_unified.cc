// ============================================================================
// EECH-HEED (2025) -- EDITED (unified environment for fair cross-protocol comparison)
// ns-3.41 / C++
//
// Same dual-zone algorithm as the paper (HEED formula in Zone1, EECH formula
// in Zone2), but packet size is standardized to 2000 bits (matching
// LEACH/HEED/SH-LEACH) instead of the paper's own 4000 bits, for direct
// apples-to-apples comparison. All other parameters (BS at center, E_DA,
// Cprob, radio model, zone structure) already matched the paper exactly and
// happen to also match this thesis's shared environment -- no other changes
// needed. For a paper-faithful reproduction instead (packet=4000), see
// hybrid_EECHHEED_ORIGINAL.cc.
// ============================================================================
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-EECHHEED-EDITED-clustering.xml");
    ...
    ofstream rounds("hybrid-EECHHEED-EDITED-results.csv");
    ofstream energy("hybrid-EECHHEED-EDITED-node-energy.csv");
    ofstream lifetime("hybrid-EECHHEED-EDITED-node-lifetime.csv");
