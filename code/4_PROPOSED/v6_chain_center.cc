...
// ============================================================================
// HYBRID PROTOCOL v6 -- CENTER VARIANT (CH-to-CH chain, NO backup, unified env.)
// ns-3.41 / C++
//
...
// RESULT of this exact file (seed 12345): FND 1415 / HND 1916 / LND 2016 / PDR 98.75%
...
//
// Same chain mechanism as v6_chain_farBS.cc (see that file's
// header for the full chain design rationale) -- same 100x100 field, same
// two-slope radio model, same neighbor RANGE -- the ONLY difference is BS
// position: here the BS sits at the field center (50,50), matching every
// other "Center" environment in the thesis's unified setup.
//
...
//   Sink at CENTER   | v3_single_pass_reuse_int5.cc           | THIS FILE (v6)    | v7_chain_backup_center.cc
//   Sink FAR         | archive/v3_old_farBS_25_-100.cc      | v6_chain_farBS.cc    | v7_chain_backup_farBS.cc
//
// v6_center vs v7_center isolates exactly the Backup-CH-Failover +
...
// ----------------------------- Network -------------------------------------
// REVERTED for this sink-center variant: unified environment (Sink at field
// center) -- this is where the math predicts CH-to-CH chaining should NOT
// help (see header). Paired with v6_chain_farBS.cc (far-BS) and both farBS/
// center baselines for the full 2x2 comparison.
...
int main(int argc, char* argv[])
{
    ...
    cout << "\n========================================\n";
    cout << "  HYBRID v6 CENTER VARIANT: CH-to-CH Chain (unified env., control test)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("v6_chain_center-clustering.xml");
    ...
    ofstream rounds("v6_chain_center-results.csv");
    ofstream energy("v6_chain_center-node-energy.csv");
    ofstream lifetime("v6_chain_center-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v6_chain_center-results.csv, v6_chain_center-node-energy.csv,\n";
    cout << "             v6_chain_center-node-lifetime.csv, v6_chain_center-clustering.xml\n";
    cout << "========================================\n";
