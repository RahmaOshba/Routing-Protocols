...
//
// REVISION NOTE (v2): this replaces the original hybrid_leach_heed_v7_combined.cc,
...
// IDENTICAL to hybrid_leach_heed_v7_center.cc; the only difference between
// the two is BS position (here BS=(50,-100), same as v6_farBS_v2.cc). This
...
// chain-repair contribution -- see hybrid_leach_heed_v6_farBS_v2.cc's
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v7-farBSv2-clustering.xml");
    ...
    ofstream rounds("hybrid-v7-farBSv2-results.csv");
    ofstream energy("hybrid-v7-farBSv2-node-energy.csv");
    ofstream lifetime("hybrid-v7-farBSv2-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v7-farBSv2-results.csv, hybrid-v7-farBSv2-node-energy.csv,\n";
    cout << "             hybrid-v7-farBSv2-node-lifetime.csv, hybrid-v7-farBSv2-clustering.xml\n";
    cout << "========================================\n";
