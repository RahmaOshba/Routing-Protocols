...
// ============================================================================
// HYBRID PROTOCOL v5+ (Setup Interval = 10): MULTI-ROUND CLUSTERING
...
// RESULT of this exact file (seed 12345): FND 1540 / HND 2090 / LND 2259 / PDR 98.70%
...
// SETUP_INTERVAL = 10 rounds. Two mechanisms added on top of v4:
//
...
static constexpr uint32_t SETUP_INTERVAL = 10; // requested variant: interval=10, combined
...
int main(int argc, char* argv[])
{
    ...
    cout << "\n========================================\n";
    cout << "  HYBRID v5+ (Setup Interval = 10): Multi-Round Clustering + Backup Failover + Chain Repair\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("v5x_backup_repair_int10-clustering.xml");
    ...
    ofstream rounds("v5x_backup_repair_int10-results.csv");
    ofstream energy("v5x_backup_repair_int10-node-energy.csv");
    ofstream lifetime("v5x_backup_repair_int10-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v5x_backup_repair_int10-results.csv, v5x_backup_repair_int10-node-energy.csv,\n";
    cout << "             v5x_backup_repair_int10-node-lifetime.csv, v5x_backup_repair_int10-clustering.xml\n";
    cout << "========================================\n";
