...
// ns-3.41 / C++
//
// REVISION NOTE: this replaces the original hybrid_leach_heed_v6_chain.cc,
...
// hybrid_leach_heed_v6_center.cc -- the ONLY difference between the two
...
//   Sink at CENTER   | v3_efficient.cc           | v6_center.cc         | v7_center.cc
//   Sink FAR         | v3_farBS_baseline.cc      | THIS FILE (v6)       | v7_farBS_v2.cc
//
...
// header). Paired with hybrid_leach_heed_v6_center.cc (same field/radio,
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v6-farBSv2-clustering.xml");
    ...
    ofstream rounds("hybrid-v6-farBSv2-results.csv");
    ofstream energy("hybrid-v6-farBSv2-node-energy.csv");
    ofstream lifetime("hybrid-v6-farBSv2-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v6-farBSv2-results.csv, hybrid-v6-farBSv2-node-energy.csv,\n";
    cout << "             hybrid-v6-farBSv2-node-lifetime.csv, hybrid-v6-farBSv2-clustering.xml\n";
    cout << "========================================\n";
