...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("v8_chain_center-clustering.xml");
    ...
    ofstream rounds("v8_chain_center-results.csv");
    ofstream energy("v8_chain_center-node-energy.csv");
    ofstream lifetime("v8_chain_center-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v8_chain_center-results.csv, v8_chain_center-node-energy.csv,\n";
    cout << "             v8_chain_center-node-lifetime.csv, v8_chain_center-clustering.xml\n";
    cout << "========================================\n";
