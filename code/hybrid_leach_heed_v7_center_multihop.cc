...
// SETUP_INTERVAL=5 as v7_center.cc -- ONLY the relay topology (chain vs.
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v7-center-multihop-clustering.xml");
    ...
    ofstream rounds("hybrid-v7-center-multihop-results.csv");
    ofstream energy("hybrid-v7-center-multihop-node-energy.csv");
    ofstream lifetime("hybrid-v7-center-multihop-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v7-center-multihop-results.csv, hybrid-v7-center-multihop-node-energy.csv,\n";
    cout << "             hybrid-v7-center-multihop-node-lifetime.csv, hybrid-v7-center-multihop-clustering.xml\n";
    cout << "========================================\n";
