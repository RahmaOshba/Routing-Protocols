...
'PEGASIS: البحث 2192 وإحنا 2167. الفرق 2.3% بس، وده تطابق ممتاز.',
'LEACH: البحث 1312 وإحنا 1321، وده مطابق لشكل 3 في البحث الأصلي.',
'HEED وSH-LEACH: البحث حاطط رسم بس من غير أرقام (graph only)، والشكل العام اتطابق.',
...
say:'First we reproduced each protocol in its own paper\'s settings. PEGASIS matched within 2.3 percent and LEACH matched the original figure, which validates our implementation.',qa:[]},
...
'LEACH: FND 1409 وLND 1962 وPDR 98.37%.',
'HEED: FND 323 بس! بيموت بدري جدًا بسبب رسايل التفاوض كل round، بس الـ PDR بتاعه عالي (99.69%). وHEED (fairness) زيه تقريبًا (338).',
'PEGASIS: أطول LND (2887) بسبب السلسلة والمسافات القصيرة، بس FND 1324.',
