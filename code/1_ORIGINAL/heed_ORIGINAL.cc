...
int main(int argc, char* argv[])
{
    ...
    cout << "Visualization = heed_ORIGINAL-clustering.xml (NetAnim)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("heed_ORIGINAL-clustering.xml");
    ...
    ofstream rounds("heed_ORIGINAL-results.csv");
    ofstream energy("heed_ORIGINAL-node-energy.csv");
    ofstream lifetime("heed_ORIGINAL-node-lifetime.csv");
    ...
    cout << "\nCSV outputs:\n";
    cout << "  heed_ORIGINAL-results.csv\n";
    cout << "  heed_ORIGINAL-node-energy.csv\n";
    cout << "  heed_ORIGINAL-node-lifetime.csv\n";
    cout << "  heed_ORIGINAL-clustering.xml\n";
    cout << "========================================\n";
