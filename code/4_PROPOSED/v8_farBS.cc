...
// ============================================================================
// HYBRID PROTOCOL v8 -- FAR BS (50,-100). Same code as v8_center.cc, only BSY changed: v5b (Backup Failover + Chain/Cluster Repair +
...
// RESULT of this exact file (seed 12345): FND 1406 / HND 1551 / LND 1606 / PDR 99.38%
...
static constexpr double BSY = -100.0;          // far BS (thesis Far-BS placement)
...
static constexpr uint32_t PACKET_BITS = 2000 + ENERGY_FIELD_BITS;
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("v8_farBS-clustering.xml");
    ...
    ofstream rounds("v8_farBS-results.csv");
    ofstream energy("v8_farBS-node-energy.csv");
    ofstream lifetime("v8_farBS-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v8_farBS-results.csv, v8_farBS-node-energy.csv,\n";
    cout << "             v8_farBS-node-lifetime.csv, v8_farBS-clustering.xml\n";
    cout << "========================================\n";
