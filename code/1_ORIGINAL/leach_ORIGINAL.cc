...
int main(int argc, char* argv[])
{
    ...
    cout << "Visualization = leach_ORIGINAL-clustering.xml (NetAnim)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("leach_ORIGINAL-clustering.xml");
    ...
    ofstream rounds("leach_ORIGINAL-results.csv");
    ofstream energy("leach_ORIGINAL-node-energy.csv");
    ofstream lifetime("leach_ORIGINAL-node-lifetime.csv");
    ...
    cout << "\nCSV outputs:\n";
    cout << "  leach_ORIGINAL-results.csv\n";
    cout << "  leach_ORIGINAL-node-energy.csv\n";
    cout << "  leach_ORIGINAL-node-lifetime.csv\n";
    cout << "  leach_ORIGINAL-clustering.xml\n";
    cout << "========================================\n";
