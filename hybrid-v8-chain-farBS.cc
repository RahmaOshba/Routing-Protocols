...
static RoundResult SimulateRound(vector<SensorNode>& nodes, uint32_t round, bool isSetupRound)
{
    ...
    auto processCH = [&](uint32_t c) {
        ...
        const double agg = static_cast<double>(members + inPackets[c]) * AggEnergy(PACKET_BITS);
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v8-chain-farBS-clustering.xml");
    ...
    ofstream rounds("hybrid-v8-chain-farBS-results.csv");
    ofstream energy("hybrid-v8-chain-farBS-node-energy.csv");
    ofstream lifetime("hybrid-v8-chain-farBS-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v8-chain-farBS-results.csv, hybrid-v8-chain-farBS-node-energy.csv,\n";
    cout << "             hybrid-v8-chain-farBS-node-lifetime.csv, hybrid-v8-chain-farBS-clustering.xml\n";
    cout << "========================================\n";
