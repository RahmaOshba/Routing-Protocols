...
//
// NEW FILE: pairs with hybrid_leach_heed_v6_center.cc (Chain, no backup) to
...
// are IDENTICAL to hybrid_leach_heed_v7_farBS_v2.cc; the only difference
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v7-center-clustering.xml");
    ...
    ofstream rounds("hybrid-v7-center-results.csv");
    ofstream energy("hybrid-v7-center-node-energy.csv");
    ofstream lifetime("hybrid-v7-center-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v7-center-results.csv, hybrid-v7-center-node-energy.csv,\n";
    cout << "             hybrid-v7-center-node-lifetime.csv, hybrid-v7-center-clustering.xml\n";
    cout << "========================================\n";
