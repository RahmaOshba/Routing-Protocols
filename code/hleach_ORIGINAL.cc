...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hleach-ORIGINAL-clustering.xml");
    ...
    ofstream rounds("hleach-ORIGINAL-results.csv");
    ofstream energy("hleach-ORIGINAL-node-energy.csv");
    ofstream lifetime("hleach-ORIGINAL-node-lifetime.csv");
