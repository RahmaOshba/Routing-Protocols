...
// ns-3.41 / C++
//
// IDENTICAL chain mechanism to v6_chain.cc (see that file's header for the
...
//
//                    | NO CHAIN                  | WITH CHAIN
//   Sink at CENTER   | v3_efficient.cc (2703)    | THIS FILE
//   Sink FAR         | v3_farBS_baseline.cc      | v6_chain.cc
//
...
// OR NO improvement over v3_efficient.cc (possibly a slight regression,
...
// that the chain's benefit (seen in v6_chain.cc) is conditional on BS
...
// help (see header). Paired with v6_chain.cc (far-BS) and both farBS/
