...
// ============================================================================
// HYBRID PROTOCOL v8 (center BS; previously misnamed hybrid-v6-optimized.cc): v5b (Backup Failover + Chain/Cluster Repair +
...
// RESULT of this exact file (seed 12345): FND 2501 / HND 2589 / LND 2636 / PDR 99.65%
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("v8_center-clustering.xml");
    ...
    ofstream rounds("v8_center-results.csv");
    ofstream energy("v8_center-node-energy.csv");
    ofstream lifetime("v8_center-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v8_center-results.csv, v8_center-node-energy.csv,\n";
    cout << "             v8_center-node-lifetime.csv, v8_center-clustering.xml\n";
    cout << "========================================\n";
