...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("pegasis_ORIGINAL-clustering.xml");
    ...
    ofstream rounds("pegasis_ORIGINAL-results.csv");
    ofstream energy("pegasis_ORIGINAL-node-energy.csv");
    ofstream lifetime("pegasis_ORIGINAL-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: pegasis_ORIGINAL-results.csv, pegasis_ORIGINAL-node-energy.csv,\n";
    cout << "             pegasis_ORIGINAL-node-lifetime.csv, pegasis_ORIGINAL-clustering.xml\n";
    cout << "========================================\n";
