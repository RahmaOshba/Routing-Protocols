...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("eechheed_ORIGINAL-clustering.xml");
    ...
    ofstream rounds("eechheed_ORIGINAL-results.csv");
    ofstream energy("eechheed_ORIGINAL-node-energy.csv");
    ofstream lifetime("eechheed_ORIGINAL-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: eechheed_ORIGINAL-results.csv, -node-energy.csv, -node-lifetime.csv\n";
    cout << "========================================\n";
    return 0;
}
