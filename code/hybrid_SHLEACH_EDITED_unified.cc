...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-SHLEACH-clustering.xml");
    ...
    ofstream rounds("hybrid-SHLEACH-results.csv");
    ofstream energy("hybrid-SHLEACH-node-energy.csv");
    ofstream lifetime("hybrid-SHLEACH-node-lifetime.csv");
