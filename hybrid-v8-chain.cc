...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v8-chain-clustering.xml");
    ...
    ofstream rounds("hybrid-v8-chain-results.csv");
    ofstream energy("hybrid-v8-chain-node-energy.csv");
    ofstream lifetime("hybrid-v8-chain-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v8-chain-results.csv, hybrid-v8-chain-node-energy.csv,\n";
    cout << "             hybrid-v8-chain-node-lifetime.csv, hybrid-v8-chain-clustering.xml\n";
    cout << "========================================\n";
