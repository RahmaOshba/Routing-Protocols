...
//
// WHY THIS RE-TUNING: after EECH-HEED and PEGASIS received their own
// improvements (adaptive threshold sensing / iterative doubling), both
// overtook v3's LND=2703 in the unified comparison (EECH-HEED-Improved:
// 3808, PEGASIS-Edited: 2887). A Python sweep of SETUP_INTERVAL --
// checked across two different random seeds for robustness -- found that
// stretching the interval further (v3 already showed 5 beats 1-round
// reclustering; v4 tests whether MORE stretching helps further) reduces
// control overhead even more and consistently extends LND well beyond
// v3's result. As always, exact resulting numbers must be confirmed by
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v4-clustering.xml");
    ...
    ofstream rounds("hybrid-v4-results.csv");
    ofstream energy("hybrid-v4-node-energy.csv");
    ofstream lifetime("hybrid-v4-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v4-results.csv, hybrid-v4-node-energy.csv,\n";
    cout << "             hybrid-v4-node-lifetime.csv, hybrid-v4-clustering.xml\n";
    cout << "========================================\n";
