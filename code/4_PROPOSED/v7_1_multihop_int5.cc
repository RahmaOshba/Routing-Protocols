...
// RESULT of this exact file (seed 12345): FND 1471 / HND 1916 / LND 2006 / PDR 99.07%
...
// SETUP_INTERVAL=5 as v7_chain_backup_center.cc -- ONLY the relay topology (chain vs.
// multihop tree) differs, so comparing the two isolates the chain-vs-
// multihop routing choice on its own.
//
...
int main(int argc, char* argv[])
{
    ...
    cout << "\n========================================\n";
    cout << "  HYBRID v7 CENTER, MULTIHOP: Multihop Routing Tree + Backup CH Failover (100x100, BS center)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("v7_1_multihop_int5-clustering.xml");
    ...
    ofstream rounds("v7_1_multihop_int5-results.csv");
    ofstream energy("v7_1_multihop_int5-node-energy.csv");
    ofstream lifetime("v7_1_multihop_int5-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v7_1_multihop_int5-results.csv, v7_1_multihop_int5-node-energy.csv,\n";
    cout << "             v7_1_multihop_int5-node-lifetime.csv, v7_1_multihop_int5-clustering.xml\n";
    cout << "========================================\n";
