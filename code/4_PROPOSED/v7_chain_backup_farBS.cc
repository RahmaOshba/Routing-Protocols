...
// ============================================================================
// HYBRID PROTOCOL v7 -- FAR-BS v2: CH-TO-CH CHAIN + BACKUP CH FAILOVER
// ns-3.41 / C++
//
...
// RESULT of this exact file (seed 12345): FND 1409 / HND 1801 / LND 1906 / PDR 98.97%
...
//
// REVISION NOTE (v2): this replaces the original archive/v7_old_farBS_25_-100.cc,
// which ran in a 50x50 field with a single-term amplifier model. This file
// keeps field size (100x100), RANGE (25) and the two-slope radio model
// IDENTICAL to v7_chain_backup_center.cc; the only difference between
// the two is BS position (here BS=(50,-100), same as v6_chain_farBS.cc). This
// makes the Center/Far comparison a true single-variable (BS location)
// test, and makes v7_farBS_v2 vs v6_farBS_v2 isolate exactly the backup +
// chain-repair contribution -- see v6_chain_farBS.cc's
...
static constexpr double BSY = -100.0;         // far below the field (was 50x50/(25,-100))
...
int main(int argc, char* argv[])
{
    ...
    cout << "\n========================================\n";
    cout << "  HYBRID v7 FAR-BS v2: Chain + Backup CH Failover + Chain Repair (100x100, BS far)\n";
    cout << "========================================\n";
    ...
    AnimationInterface anim("v7_chain_backup_farBS-clustering.xml");
    ...
    ofstream rounds("v7_chain_backup_farBS-results.csv");
    ofstream energy("v7_chain_backup_farBS-node-energy.csv");
    ofstream lifetime("v7_chain_backup_farBS-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: v7_chain_backup_farBS-results.csv, v7_chain_backup_farBS-node-energy.csv,\n";
    cout << "             v7_chain_backup_farBS-node-lifetime.csv, v7_chain_backup_farBS-clustering.xml\n";
    cout << "========================================\n";
