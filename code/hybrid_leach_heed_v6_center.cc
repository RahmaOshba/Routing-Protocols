...
// ns-3.41 / C++
//
// Same chain mechanism as hybrid_leach_heed_v6_farBS_v2.cc (see that file's
...
//   Sink at CENTER   | v3_efficient.cc           | THIS FILE (v6)    | v7_center.cc
//   Sink FAR         | v3_farBS_baseline.cc      | v6_farBS_v2.cc    | v7_farBS_v2.cc
//
...
// help (see header). Paired with v6_farBS_v2.cc (far-BS) and both farBS/
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v6-chain-center-clustering.xml");
    ...
    ofstream rounds("hybrid-v6-chain-center-results.csv");
    ofstream energy("hybrid-v6-chain-center-node-energy.csv");
    ofstream lifetime("hybrid-v6-chain-center-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v6-chain-center-results.csv, hybrid-v6-chain-center-node-energy.csv,\n";
    cout << "             hybrid-v6-chain-center-node-lifetime.csv, hybrid-v6-chain-center-clustering.xml\n";
    cout << "========================================\n";
