...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("heed-clustering.xml");
    ...
    ofstream rounds("heed-results.csv");
    ofstream energy("heed-node-energy.csv");
    ofstream lifetime("heed-node-lifetime.csv");
