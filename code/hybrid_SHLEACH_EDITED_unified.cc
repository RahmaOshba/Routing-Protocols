...
// ns-3.41 / C++
//
// Same CH-selection formula as the paper (HEED-style energy probability +
// CHcho fairness penalty, embedded in LEACH's round structure), but the
// ENVIRONMENT is standardized to match LEACH/HEED/EECH-HEED exactly:
// two-slope Efs/Emp/d0 radio model, packet=2000 bits, BS at field center,
// N=100, 100x100m field. This is the version to use for direct,
// apples-to-apples comparison against the other protocols.
// For a paper-faithful reproduction instead, see hybrid_SHLEACH_ORIGINAL.cc.
// ============================================================================
