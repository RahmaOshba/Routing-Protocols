...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hleach_IMPROVED-clustering.xml");
    ...
    ofstream rounds("hleach_IMPROVED-results.csv");
    ofstream energy("hleach_IMPROVED-node-energy.csv");
    ofstream lifetime("hleach_IMPROVED-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hleach_IMPROVED-results.csv, hleach_IMPROVED-node-energy.csv,\n";
    cout << "             hleach_IMPROVED-node-lifetime.csv, hleach_IMPROVED-clustering.xml\n";
    cout << "========================================\n";
