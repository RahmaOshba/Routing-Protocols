...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v5-int5-clustering.xml");
    ...
    ofstream rounds("hybrid-v5-int5-results.csv");
    ofstream energy("hybrid-v5-int5-node-energy.csv");
    ofstream lifetime("hybrid-v5-int5-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v5-int5-results.csv, hybrid-v5-int5-node-energy.csv,\n";
    cout << "             hybrid-v5-int5-node-lifetime.csv, hybrid-v5-int5-clustering.xml\n";
    cout << "========================================\n";
