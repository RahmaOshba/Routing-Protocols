...
// in hybrid_leach_heed_v7_center.cc against a MULTIHOP routing tree instead:
//
//   Chain (v7_center.cc): CHs form ONE linear path (nearest-neighbor greedy
...
// as v7_center.cc. SETUP_INTERVAL changed to 10 (was 5, matching v7_center)
...
// v7_center.cc (chain, interval=5) isolates the routing-topology effect alone.
//
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v7-center-multihop-int10-clustering.xml");
    ...
    ofstream rounds("hybrid-v7-center-multihop-int10-results.csv");
    ofstream energy("hybrid-v7-center-multihop-int10-node-energy.csv");
    ofstream lifetime("hybrid-v7-center-multihop-int10-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v7-center-multihop-int10-results.csv, hybrid-v7-center-multihop-int10-node-energy.csv,\n";
    cout << "             hybrid-v7-center-multihop-int10-node-lifetime.csv, hybrid-v7-center-multihop-int10-clustering.xml\n";
    cout << "========================================\n";
