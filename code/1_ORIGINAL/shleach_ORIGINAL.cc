...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("shleach_ORIGINAL-clustering.xml");
    ...
    ofstream rounds("shleach_ORIGINAL-results.csv");
    ofstream energy("shleach_ORIGINAL-node-energy.csv");
    ofstream lifetime("shleach_ORIGINAL-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: shleach_ORIGINAL-results.csv, shleach_ORIGINAL-node-energy.csv,\n";
    cout << "             shleach_ORIGINAL-node-lifetime.csv, shleach_ORIGINAL-clustering.xml\n";
    cout << "========================================\n";
