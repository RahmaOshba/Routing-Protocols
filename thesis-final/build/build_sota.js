...
const body = [
  ...titlePage('State-of-the-Art Report', 'Energy-efficient clustering in WSNs — what we did, what we found, and the proposed protocol v8 (+ v8-Chain for a far base station)',
    ...
    ['1. What we did', '2. Setup and energy model', '3. Classic protocols', '4. Hybrid protocols', '5. Recent work', '6. Proposed protocol (v1 → v8, v8-Chain)',
      '7. Final comparison — BS at the centre', '8. Final comparison — BS far away', '9. Expected cost of security', '10. Limitations', '11. Conclusion', 'References']),
  ...
  N('Tested every protocol with the BS at the centre and far away, and estimated the cost of adding security.'),
  ...
  H1('9. Expected cost of security'),
  P('Hybrid cryptography: ECC key agreement once at deployment, AES + 8-byte MIC on every frame. Measured by running the protocol with the overhead switched on (centre = v8, far BS = v8-Chain).'),
  ...
  ...fg('s1_security.png', 6.3, 'FND with security overhead.'),
