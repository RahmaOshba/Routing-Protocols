...
// ns-3.41 / C++
//
// Same algorithm as the paper (energy-weighted LEACH-style threshold +
// "energy > average" gate + necessary fallback -- see ORIGINAL file's
// header for the full reconstruction story), but packet size is
// standardized to 2000 bits (matching LEACH/HEED/SH-LEACH/EECH-HEED)
// instead of the paper's own 4000 bits. Every other parameter (100x100m
// field, BS at center, two-slope Efs/Emp/d0 radio, E0=0.5J, P=0.1)
// already matched this thesis's unified environment by coincidence -- a
// genuine match, not an adjustment (this paper happens to use almost
// exactly the same environment as the rest of this thesis already).
// For the paper-faithful reproduction (packet=4000), see
// hleach_ORIGINAL.cc.
// ============================================================================
...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hleach-EDITED-clustering.xml");
    ...
    ofstream rounds("hleach-EDITED-results.csv");
    ofstream energy("hleach-EDITED-node-energy.csv");
    ofstream lifetime("hleach-EDITED-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hleach-EDITED-results.csv, hleach-EDITED-node-energy.csv,\n";
    cout << "             hleach-EDITED-node-lifetime.csv, hleach-EDITED-clustering.xml\n";
    cout << "========================================\n";
