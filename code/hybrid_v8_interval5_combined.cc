...
int main(int argc, char* argv[])
{
    ...
    AnimationInterface anim("hybrid-v5b-energyaware-clustering.xml");
    ...
    ofstream rounds("hybrid-v5b-energyaware-results.csv");
    ofstream energy("hybrid-v5b-energyaware-node-energy.csv");
    ofstream lifetime("hybrid-v5b-energyaware-node-lifetime.csv");
    ...
    cout << "\nCSV outputs: hybrid-v5b-energyaware-results.csv, hybrid-v5b-energyaware-node-energy.csv,\n";
    cout << "             hybrid-v5b-energyaware-node-lifetime.csv, hybrid-v5b-energyaware-clustering.xml\n";
    cout << "========================================\n";
